    ...
    <div className="flex flex-col items-center border rounded-xl w-full xl:h-[84%] items-center pb-[20px]">
      ...
      {showWidget && (
        <div className="mt-1 w-[95%] xl:h-[30%] bg-[#F1EEF6] border rounded-xl">
          ...
          ></input>
          <p className="text-[black] text-[15px] text-left mt-1 xl:mt-2">
            Time
          </p>
          <div className="flex">
            <input
              type="time"
              className="form-control w-[16%] h-[20%] mr-1 ml-1 mt-[-1%] xl:mt-[-3%]"
              style={{
                width: "98%",
                height: "130%",
              }}
            ...
            <input
              type="time"
              className="form-control w-[18%] h-[20%] mr-4 xl:mr-2 ml-1 mt-[-1%] xl:mt-[-3%]"
              style={{
                width: "98%",
                height: "130%",
              }}
          ...
          <div className="flex justify-between mt-1">
            <button
              className="text-[#5534A5] text-[18px] ml-20 mt-1"
              onClick={(e) => {
            ...
            <button
              className="text-[black] text-[18px] mr-20 mt-1"
              onClick={(e) => {
                setShowWidget(false);
              }}
            >
        ...
        <div className="flex border w-[94%] md:h-[20%] xl:h-[15%] rounded-xl mt-2 justify-between z-[0]">
          ...
          <div className="flex w-[94%] rounded-xl">
            <div className="flex flex-col justify-between">
              ...
              <p className="text-[#757575] text-left ml-5 text-[15px]">
                {dailyPlanTime[index]}
              </p>
            </div>
          </div>
